...
>
> CI (`.github/workflows/ci.yml`) hits this same problem — GitHub Actions has no access to that GitLab repo — and automates this exact workaround for its own ephemeral checkout.
