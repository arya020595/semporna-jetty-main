...
import VPassengerTable from "./_partials/VPassengerTable.vue";
import VApprovement from "./_partials/VApprovement.vue";
...
const { manifest, urlBack, qrcode, urlDownload, bypassApproval, isSeafest } =
    props.additional;
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 text-lg-end text-center">
                        ...
                        <div
                            class="d-flex flex-column align-items-center align-items-lg-end mt-2 text-center text-lg-end"
                        >
                            <img
                                :src="qrcode"
