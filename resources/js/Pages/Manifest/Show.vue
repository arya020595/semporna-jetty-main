...
import VShowStep3 from "./_partials/VShowStep3.vue";
import VShowStep4 from "./_partials/VShowStep4.vue";
import VShowOverall from "./_partials/VShowOverall.vue";
import { computed } from "vue";
import VShowOverallAdditional from "./_partials/VShowOverallAdditional.vue";
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-5">
                    <Link :href="urlActivity" class="btn fw-bold">
                        <span class="material-icons"> chevron_left </span>
                        Back To Activity</Link
                    >
                    <div class="">
                        <Link
                            v-if="isPaymentStatusPending && !isSeafest"
                            :href="urlPayment"
                            class="btn btn-success me-2"
                        >
                            <span class="icon-paynow">
                                <img
